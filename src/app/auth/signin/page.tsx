...
export default async function SignInPage({
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900">
      <div className="w-full max-w-md p-4">
        ...
        <MagicCard 
          className="border-2 border-transparent bg-white/80 shadow-xl backdrop-blur-sm dark:bg-gray-800/80 rounded-2xl"
          gradientSize={300}
          gradientFrom="#3B82F6"
          gradientTo="#8B5CF6"
          ...
          gradientOpacity={0.3}
        >
          <Card className="border-5 bg-transparent shadow-none">
